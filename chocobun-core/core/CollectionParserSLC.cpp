...
// // --------------------------------------------------------------
// bool CollectionParserSLC::isLevelData( const std::string& str )
// {
...
// // --------------------------------------------------------------
// bool CollectionParserSLC::getKeyValuePair( const std::string& str, std::string& key, std::string& value )
// {
...
// // --------------------------------------------------------------
// void CollectionParserSLC::enableCompression( void )
// {
//     m_EnableRLE = true;
// }

// // --------------------------------------------------------------
// void CollectionParserSLC::disableCompression( void )
// {
//     m_EnableRLE = false;
// }
